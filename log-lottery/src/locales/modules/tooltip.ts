...
export const tooltipEn = {
    ...
    prizeRepeatable: 'When enabled, the same prize can be drawn again after each round; winners of this prize are excluded from the next round. Uncheck or mark "Done" to stop.',
...
export const tooltipZhCn = {
    ...
    prizeRepeatable: '开启后，每轮抽满人数不会自动变为「已抽取」，可继续抽同一奖项；已中本奖的人会进入下一轮排除名单。需停止时请取消勾选或手动勾选「已抽取」。',
