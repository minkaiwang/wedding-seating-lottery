export const dialogEn = {
    ...
    dialogResetPrizeProgress: 'Reset all prize draw progress and clear winner records? The guest list will be kept.',
...
export const dialogZhCn = {
    ...
    dialogResetPrizeProgress: '将重置所有奖项的已抽进度并清空中奖记录，人员名单保留。是否继续？',
