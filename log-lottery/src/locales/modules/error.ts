export const errorEn = {
    ...
    success: 'Success',
    fail: 'Failed',
    weddingSeatingBridgeSuccess: 'Guest list imported from WeddingSeats',
    weddingSeatingBridgeInvalid: 'Invalid data from WeddingSeats (need at least one name)',
}
...
export const errorZhCn = {
    ...
    success: '成功',
    fail: '失败',
    weddingSeatingBridgeSuccess: '已从 WeddingSeats 导入宾客名单',
    weddingSeatingBridgeInvalid: 'WeddingSeats 传来的数据无效（至少需要一位姓名）',
}
